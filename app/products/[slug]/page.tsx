...
export default async function ProductDetailPage({ params }: { params: Promise<{ slug:string }> }) {
  ...
  if (!product) return <main className="product-detail"><section className="product-not-found"><h1>Product not found</h1><a href="/products">Return to vehicles</a></section></main>;
  ...
  return <main className="product-detail">
    ...
    <section className="product-detail-bottom"><div><p>PIAGGIO AUTHORISED DEALER</p><h2>See this vehicle at Durga Motors.</h2></div><a href="/contact">Contact our team →</a></section>
  </main>;
}
